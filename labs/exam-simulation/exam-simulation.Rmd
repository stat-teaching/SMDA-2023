...
\ifsol
Mean centering does not affect the overall model fit or regression coefficients but only the Intercept. Now the Intercept `r print_beta(fit2_cen, "(Intercept)")` is the expected log odds of having anxiety for people without familiarity, with social network 0 and a median value of self-esteem.
\fi
