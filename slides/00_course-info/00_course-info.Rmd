...
- Download and extract the **template course folder** from here
- Open the `SMDA-2023.Rproj` file
- Now the command `devtools::load_all()` will load each function within the `R/` folder. You can consider this folder as an R Package
