...
We can interpret the deviance similarly to the sum of squares in standard linear regression. With GLM the idea is to compare the current model or the null model with a saturated model and find the **null** and **residual** deviance.
