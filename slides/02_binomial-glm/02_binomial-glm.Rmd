...
fit <- glm(y ~ x, data = sim, family = poisson(link = "log"))

(plot_resid(fit, type = "response") + mytheme()) + (plot_resid(fit, type = "pearson") + mytheme())
```
...
## Binomial GLM Standardized Residuals `#extra`{.allowframebreaks}
